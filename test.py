...
def get_args_parser():
    ...
    parser.add_argument('--split_root', default='./data/split/data/')
    parser.add_argument('--dataset', default='rs_ov_try')
    parser.add_argument('--test_split', default='test')
    parser.add_argument('--img_size', default=640)
    parser.add_argument('--cache_images', action='store_true')
    parser.add_argument('--output_dir', default='rsvg/orig/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--save_pred_path', default='')
    parser.add_argument('--device', default='cuda:0',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--checkpoint', default='hy_rsvg/checkpoint0088.pth', help='resume from checkpoint')
    ...
    # configure file
    parser.add_argument('--config', default='configs/VLTVG_R101_rs_ov_try.py', type=str, help='Path to the configure file.')
