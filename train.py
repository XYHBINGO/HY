...
def get_args_parser():
    ...
    parser.add_argument('--dataset', default='hyhb_rsvg')
    ...
    parser.add_argument('--output_dir', default='hyhb_rsvg/orig/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--save_pred_path', default='5')
    ...
    # configure file
    parser.add_argument('--config', default='configs/VLTVG_R101_hy_rsvg.py', type=str, help='Path to the configure file.')
